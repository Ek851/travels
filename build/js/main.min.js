...
},{"./modules/form-validate/form":3,"./modules/menu":9,"./modules/modals/init-modals":10,"./modules/sliders/init-hero-slider":12,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
var buttonOpen = document.querySelector('[data-menu="button-open"]');
var buttonClose = document.querySelector('[data-menu="button-close"]');
var navLinks = document.querySelectorAll('[data-menu="nav-link"]');
...
var heroSlider = document.querySelector('[data-slider="hero-slider"]');
var heroPagination = document.querySelector('[data-slider="hero-pagination"]');
var swiperHero = new _swiper.default(heroSlider, {
  pagination: {
    el: heroPagination,
    type: 'bullets',
    clickable: true
